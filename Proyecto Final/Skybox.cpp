...
Skybox::Skybox(std::vector<std::string> faceLocations)
{
	...
	{
		// Para HDRIs, necesitamos cargar con más bits por canal
		stbi_set_flip_vertically_on_load(false); // Importante: desactivar flip para cubemaps
		...
		// Determinar formato basado en canales
	...
	glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR); // Mejor calidad
